...
asset_options.flip_visual_attachments = asset_descriptor.flip_visual_attachments
...
rigid_body_names = gym.get_actor_rigid_body_names(envs[0], 0)

# get array of rigid body properties
rigid_body_props = gym.get_actor_rigid_body_properties(envs[0], 0)

# get array of rigid shape properties
rigid_shape_props = gym.get_actor_rigid_shape_properties(envs[0], 0)
